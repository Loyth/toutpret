...
public class FragmentCommandeEnPreparation extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_orderpicker_commandes_en_preparation, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.orderpicker_commande_en_preparation_recyclerview_id);
