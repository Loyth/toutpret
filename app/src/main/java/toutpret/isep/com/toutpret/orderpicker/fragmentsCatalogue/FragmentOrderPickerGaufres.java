...
public class FragmentOrderPickerGaufres extends Fragment {
    View view;
    ...
    public FragmentOrderPickerGaufres() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_orderpicker_gaufres, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.orderpicker_gaufres_recyclerview_id);
        ...
        Button add = view.findViewById(R.id.orderpicker_gaufres_add_button);
