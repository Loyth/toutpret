...
public class FragmentBoissons extends Fragment implements FragmentInterface {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_boissons, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.boissons_recyclerview_id);
        ...
        /*panier = view.findViewById(R.id.boissons_panier);
