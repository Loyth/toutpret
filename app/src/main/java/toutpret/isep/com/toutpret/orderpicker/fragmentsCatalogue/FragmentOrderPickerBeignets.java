...
public class FragmentOrderPickerBeignets extends Fragment {
    View view;
    ...
    public FragmentOrderPickerBeignets() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_orderpicker_beignets, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.orderpicker_beignets_recyclerview_id);
        ...
        Button add = view.findViewById(R.id.orderpicker_beignets_add_button);
