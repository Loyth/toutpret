...
public class FragmentCommandesPretes extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_commandes_pretes, container, false);
    ...
    private void getCommandes() {
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
                ...
                if (newCommande.getStatus().equals("Prête")) {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String prevChildKey) {
                ...
                for (Commandes commandes : listCommandes) {
                    if (commandes.getNumeroCommande().equals(commandesChanged.getNumeroCommande())) {
                        ...
                        if (commandesChanged.getStatus().equals("Prête")) {
