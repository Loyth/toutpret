...
public class FragmentOrderPickerGlaces extends Fragment {
    View view;
    ...
    public FragmentOrderPickerGlaces() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_orderpicker_glaces, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.orderpicker_glaces_recyclerview_id);
        ...
        Button add = view.findViewById(R.id.orderpicker_glaces_add_button);
