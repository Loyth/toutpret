...
public class FragmentOrderPickerCrepes extends Fragment {
    View view;
    ...
    public FragmentOrderPickerCrepes() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_orderpicker_crepes, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.orderpicker_crepes_recyclerview_id);
        ...
        Button add = view.findViewById(R.id.orderpicker_crepes_add_button);
