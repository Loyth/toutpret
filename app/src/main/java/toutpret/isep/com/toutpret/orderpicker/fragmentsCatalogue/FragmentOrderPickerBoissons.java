...
public class FragmentOrderPickerBoissons extends Fragment {
    View view;
    ...
    public FragmentOrderPickerBoissons () {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_orderpicker_boissons, container, false);
        ...
        RecyclerView myrv = view.findViewById(R.id.orderpicker_boissons_recyclerview_id);
        ...
        Button add = view.findViewById(R.id.orderpicker_boissons_add_button);
